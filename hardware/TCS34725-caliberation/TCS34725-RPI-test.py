...
class TCS34725():
    ...
    def gain_selection(self):
        """Select tyhe gain register configuration from the given provided values"""
        bus.write_bte_data(TCS34725_DEFAULT_ADDRESS, TCS34725_REG_CONTROL | TCS34725_COMMAND_BIT, TCS34725_REG_CONTROL_AGAIN_1)
